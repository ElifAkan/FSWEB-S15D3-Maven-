...
public class Main {
    ...
    public static void main(String[] args) {
      //  List<Employee> employees = new ArrayList<>();
        //employees.add(new Employee(1, "Mehmet", "Yılmaz"));
        //employees.add(new Employee(1, "Mehmet", "Yılmaz"));
        //employees.add(new Employee(1, "Mehmet", "Yılmaz"));
        //employees.add(new Employee(2, "Elif", "Akan"));
        //employees.add(new Employee(2, "Elif", "Akan"));
        //employees.add(new Employee(3, "Berk", "Yılmazer"));
        //employees.add(new Employee(4, "Burak", "Bayrak"));
        //employees.add(new Employee(5, "Ece", "Tutar"));
